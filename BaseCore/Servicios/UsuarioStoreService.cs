...
namespace BaseCore.Servicios
{
    public class UsuarioStoreService : IUserStore<Usuario>, IUserEmailStore<Usuario>, IUserPasswordStore<Usuario>
    {
        ...
        public UsuarioStoreService(IUsuariosRepositorio usuariosRepositorio)
        {
        ...
        {
            user.Id = await _usuariosRepositorio.CrearUsuario(user);
        ...
        {
            return await _usuariosRepositorio.BuscarUsuarioPorEmail(normalizedEmail);
        }
        ...
        {
            return await _usuariosRepositorio.BuscarUsuarioPorEmail(normalizedUserName);
        }
